...
function death( )
	...
	local key6 = "ESSENCE_MYSTERY_PICKUP_COUNT"
	...
	local pick6 = tonumber( GlobalsGetValue( key6, "0" ) )
	...
	if ( pick6 > 0 ) then
		for i=1,pick6 do
			table.insert( loadlist, "data/entities/items/pickup/mysterystone.xml" )
		end
		
		GlobalsSetValue( key6, "0" )
	end
	...
	GameRemoveFlagRun( "essence_mystery" )
